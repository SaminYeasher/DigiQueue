...
class StudentInboxScreen extends ConsumerWidget {
...
class _MessageCard extends ConsumerWidget {
  ...
  Color _typeColor() {
    if (message.subject.contains('Accepted')) return AppColors.success;
    if (message.subject.contains('Rejected')) return AppColors.error;
    if (message.subject.contains('Rescheduled')) return AppColors.warning;
