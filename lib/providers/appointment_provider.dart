...
final facultyUsersProvider = StreamProvider.autoDispose<List<UserModel>>((ref) {
...
final facultyAppointmentsProvider =
    StreamProvider.autoDispose.family<List<AppointmentModel>, String>((ref, facultyId) {
  final db = ref.watch(databaseServiceProvider);
...
final studentAppointmentsProvider =
    StreamProvider.autoDispose.family<List<AppointmentModel>, String>((ref, studentId) {
  final db = ref.watch(databaseServiceProvider);
